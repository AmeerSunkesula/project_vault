        ...
        <div class="container">
            <div class="hero-content">
                ...
                <div class="hero-actions">
                    ...
                    <?php if (!is_logged_in()): ?>
                    <a href="/auth/register.php?redirect_to=<?php echo rawurlencode($_SERVER['REQUEST_URI'] ?? '/'); ?>" class="btn btn-outline btn-lg">
                        <i class="fas fa-user-plus"></i>
                        Join Now
                    </a>
                    <?php endif; ?>
        ...
        <div class="container">
            ...
            <div class="text-center">
                <div class="empty-state">
                    ...
                    <?php else: ?>
                    <a href="/auth/register.php?redirect_to=<?php echo rawurlencode($_SERVER['REQUEST_URI'] ?? '/'); ?>" class="btn btn-primary">
                        <i class="fas fa-user-plus"></i>
            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="projects/">Projects</a></li>
                        <li><a href="projects/">Projects</a></li>
                        <li><a href="/auth/register.php?redirect_to=<?php echo rawurlencode($_SERVER['REQUEST_URI'] ?? '/'); ?>">Register</a></li>
                    </ul>
                </div>
